...
class EquilateralTriangle(EquilateralPolygon):
    """
    Triangle with 3 equal sides centered at cx,cy.
    """
    ...
    def __init__(self, cx=0.0, cy=0.0, side_length=10, rotation=(-math.pi/6.0), 
                 stroke_width=3, stroke_opacity=1.0, opacity=1.0, 
                 stroke=rgb(0,0,0), fill=rgb(255, 255, 255)):

        EquilateralPolygon.__init__(
            self, cx=cx, cy=cy, sides=3, side_length=side_length, 
