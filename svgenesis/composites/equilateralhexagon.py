...
class EquilateralHexagon(EquilateralPolygon):
    """
    Hexagon with size equal sides centered at cx,cy.
    """
    @staticmethod
    ...
    def __init__(self, cx=0.0, cy=0.0, side_length=10, 
        ...
        EquilateralPolygon.__init__(self, cx=cx, cy=cy, sides=6, side_length=side_length, 
    ...
    def to_node(self):
        ...
        # the object from XML.
        node.setAttribute(SVGENESIS_TYPE, 'EquilateralHexagon')
        return node
